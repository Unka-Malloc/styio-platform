...
EXPECTED_OPERATION_SNAPSHOT = [
    ...
    ("registerCompileContainer", "POST", "/compile-containers/register"),
    ("getCompileContainer", "GET", "/compile-containers/{container_id}"),
    ("switchCompileContainerWorkspace", "POST", "/compile-containers/{container_id}/switch-workspace"),
