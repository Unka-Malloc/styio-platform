...
**Purpose:** Freeze the frontend/backend HTTP contract used by hosted workspaces so `styio-view`, the future platform control console, and backend services can develop independently against a versioned native JSON package.
