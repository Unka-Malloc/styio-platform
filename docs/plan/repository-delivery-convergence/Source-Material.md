...
| Path | Entry | Summary |
|------|-------|---------|
| `Platform-Migration-Plan.md` | [Styio Cloud Control Plane Convergence](./Platform-Migration-Plan.md) | Capture the migration boundary from pafio into the global styio-cloud cloud-service and package-distribution foundation. |
```

## source-002-styio-cloud-control-plane-convergence: Styio Cloud Control Plane Convergence
